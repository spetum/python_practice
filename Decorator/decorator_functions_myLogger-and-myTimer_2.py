...
def my_logger(orig_func):
    import logging
    logging.basicConfig(filename='{}.2.log'.format(orig_func.__name__), level=logging.INFO)
...
# wrapper.2.log가 출력되는지 이해가 될지도.
# 어떤 순서로 해도 wrapper가 아닌 원래 호출한 함수를 출력하기 위해
# 다음 소스에서 from functools import wraps 를 이용해보자.
